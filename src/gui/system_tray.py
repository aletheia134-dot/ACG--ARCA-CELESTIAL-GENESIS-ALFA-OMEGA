...
# -*- coding: utf-8 -*-
"""
system_tray.py - Ícone na Bandeja do Sistema para Controle da Arca

Integra com pystray para ícone persistente na bandeja.
...
class SystemTray:
    ...
    def start(self) -> None:
        ...
        logger.info("âœ… Ícone da bandeja iniciado")
    ...
    def stop(self) -> None:
        ...
        if self.icon:
            self.icon.stop()
            logger.info("âœ… Ícone da bandeja parado")
