...
# -*- coding: utf-8 -*-
"""
alma_avatar_frame.py - Frame para Exibio de Avatar de Alma

Exibe avatar animado com expresses faciais e texto de fala.
Integra com motores de expresso individual.
"""
...
class AlmaAvatarFrame(ttk.Frame):
    """
    Frame que exibe avatar de uma alma com expresses e fala.
    """
    ...
    def _carregar_avatar_base(self) -> None:
        """Carrega avatar base (crculo simples)."""
    ...
    def atualizar_expressao(self, expressao: str) -> None:
        """Atualiza expresso facial."""
        self._expressao_atual = expressao
        
        # Modificar boca baseada na expresso
    ...
    def falar(self, texto: str) -> None:
        ...
        # Auto-clear aps 5 segundos
        self.after(5000, lambda: self.label_fala.config(text=""))
    
    def _loop_atualizacao(self) -> None:
        """Loop de atualizao para animaes."""
        while self._running:
            try:
                time.sleep(0.1)
                
                # Verificar se h motores individuais
                if self.coracao_ref:
                ...
                logger.debug(f"Erro na atualizao: {e}")
