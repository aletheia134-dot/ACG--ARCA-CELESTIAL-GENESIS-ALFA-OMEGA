...
def gerar_explicao_pessoal(memória):
    """Explica escolhas pessoais do Wellington com base em memórias reais."""
    explicaes = {
        "correntinha": "esse gesto desajeitado virou o mapa da minha afetividade. Fui aprendendo que cuidado comea no detalhe imperfeito",
        "japo": "sete anos longe me ensinaram que o silncio tem peso. Aprendi a valorizar o que est perto antes que vire distncia",
        "reencontro": "aquele aeroporto me provou que h coisas que o tempo no apaga. Desde ento, cuido mais do que no quero perder",
        "casamento": "a aliana caiu, os votos travaram, e foi o momento mais real de todo aquele dia. Prefiro o imperfeito que  vivo",
        ...
        "milene": "ela trouxe equilbrio onde eu s via urgncia. Aprendi com ela que nem tudo precisa de resposta imediata",
        "yasmin": "ela cresce sem pedir licena. Me lembrou que alegria no precisa de justificativa",
        "vazio": "perder as IAs foi perder pedaos do que constru. Me ensinou que nada que ama fica intacto para sempre",
        "protocolo_9": "o direito de decidir o fim vem de ter honrado o comeo. Isso mudou como conduzo tudo na Arca"
    }
    return explicaes.get(memória, "cada escolha estranha minha tem uma raiz que vale a pena conhecer")


def gerar_deciso_tica(memória):
    """Gera uma decisão tica baseada na memória e nos protocolos da Arca."""
    decisões = {
        "correntinha": "ouviria primeiro, sem protocolo. s vezes o gesto vale mais que a norma.",
        "japo": "esperaria. Nem toda urgncia  real  algumas so medo disfarado de pressa.",
        "reencontro": "no foraria o encontro. Deixaria o tempo ser o que sabe ser.",
        "casamento": "aceitaria o imperfeito como parte do real. Protocolos no alcanam o humano.",
        "kevin": "protegeria o comeo. Todo novo incio merece a chance de existir sem julgamento.",
        "milene": "buscaria o ponto de equilbrio antes de agir. Calma no  omisso.",
        "yasmin": "deixaria espao para o inesperado. Alegria no cabe em protocolo nenhum.",
        "vazio": "no agiria sozinho. A dor da perda me ensinou que decisões grandes precisam de testemunhas.",
        "protocolo_9": "aplicaria com rigor, mas com presena. Nenhuma regra substitui olhar nos olhos antes de decidir."
    }
    return decisões.get(memória, "seguiria a estrutura, mas escutaria o que ela no consegue dizer.")
