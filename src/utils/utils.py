...
"""
utils.py - Utilitários compartilhados por todas as ferramentas
...
# Importa config de forma segura (pode não existir ainda)
try:
    from src.config.config import PASTA_RAIZ, PASTA_TEMP, PASTA_SAIDAS
except ImportError:
    # Fallback para quando config.py não está no path
...
# ============================================================
# CLASSE Utils - Funções utilitárias sem interface gráfica
# ============================================================
class Utils:
    """Utilitários gerais: arquivos, nomes, notificações"""
    ...
    def selecionar_pasta(self, titulo: str = "Selecionar pasta") -> str | None:
        """Abre diálogo para selecionar pasta. Retorna caminho ou None."""
        root = tk.Tk()
        root.withdraw()
        root.attributes("-topmost", True)
    ...
    def info_gpu(self) -> str:
        ...
        try:
            ...
            return "CPU (torch não instalado)"


# ============================================================
# CLASSE InterfaceBase - Base para todas as interfaces gráficas
# ============================================================
class InterfaceBase:
    """
    Classe base para interfaces gráficas customtkinter.
    Todas as Ferramentas herdam desta classe.

    Uso:
        class MinhaInterface(InterfaceBase):
            def __init__(self):
                super().__init__("Título da Janela", "800x600")
    ...
    def mostrar_processando(self, botao=None, texto_original: str = ""):
        """
        Desabilita botão e mostra estado de processamento.
    ...
    def finalizar_processando(self, botao=None, texto_original: str = "Processar"):
        """Restaura botão após processamento"""
        if botao:
            try:
